...
import { DARKGREY, LIGHTGREY } from "../constants/palette";

export const PrivacyScreen = () => {
  return (
    <>
      <Text style={styles.title}>Privacy Policy of Pharma Delivery</Text>
      <View style={styles.container}>
        <Text style={{ ...styles.text, paddingTop: 15 }}>
          Pharma Delivery operates the website, which provides the service. This
          page is used to inform website visitors regarding our policies with
          the collection, use, and disclosure of Personal Information if anyone
          decided to use our Service, the pharmadelivery.com website. If you
          ...
          Terms and Conditions, which is accessible at www.pharmadelivery.com,
        ...
        <Text style={styles.text}>
          ...
          portions of our Service. For more general information on cookies,
